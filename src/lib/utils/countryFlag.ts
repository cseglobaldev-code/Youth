...
// Common English country names (plus a few aliases used elsewhere in the app,
// e.g. the "VietNam" casing in RegisterOrganizationModal) mapped to their
// ISO 3166-1 alpha-2 code, keyed lowercase for case-insensitive lookups.
const COUNTRY_ISO_CODES: Record<string, string> = {
  ...
  'north korea': 'KP', kosovo: 'XK', kuwait: 'KW', kyrgyzstan: 'KG', laos: 'LA',
